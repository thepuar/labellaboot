 ...
 * @author thepuar
 */
public class LaBellaProv {

    private LaBellaModel labella;
//    private HLaBella hlabella;

    public void init() {
//        hlabella = new HLaBella();
//        labella = new LaBellaModel();
//        if (hlabella.selectAll(LaBellaModel.class).size() == 0) {
//            hlabella.insert(labella);
...
//                if (labella.getProveedorByNum(preprov.getNumero()) == null) {
//                    //El proveedor no existe, lo añado.
//                    List<Pedido> listapedidos = preprov.getPedidos();
//                    preprov.setPedidos(null);
//                    Historico historicoprov = new Historico("PROV", "Info", preprov.getNumero().toString(), "Creado", 0);
...
//                    preprov.setPedidos(null);
//                    proveedorcreado++;
//                    System.out.println("#1.1 - " + proveedorcreado + " El proveedor no existe, paso a añadirlo: " + preprov.getNombre());
//                    Historico historicoprov = new Historico("PROV", "Info", preprov.getNumero().toString(), "Creado", 0);
//                    preprov.addHistorico(historicoprov);
//                    hproveedor.insert(preprov);
//
...
//                        if (temp == null) {
//                            //El pedido no existe, lo añado a los pedidos del proveedor y a los pedidos de la seccion.
...
//                            Historico historicoped = new Historico("Ped", "Info", preped.getNumeropedido().toString(), "Creado", 0);
//                            preped.setNumPalets(1);
//                            if (preped.getProveedor().getFranco() != null && preped.getProveedor().getFranco() > preped.getImportePC()) {
...
//                        } else {
//                            pedidoexiste++;
//                            System.out.println("#1.2.2 - " + pedidoexiste + " El pedido " + preped.getNumeropedido() + " existe");
//                            if (temp.getFechaentregaReal().compareTo(new Date()) < 0) {
//                                temp.setRetraso(true);
//                                hpedido.update(temp);
//                            }
//                            if (temp.isEnCurso() == false) {
//                                temp.setEnCurso(true);
//
//                                hpedido.update(temp);
//                            }
//                            if (temp.getImportePC() == null && preped.getImportePC() != null) {
//                                temp.setImportePC(preped.getImportePC());
//                                if (temp.getProveedor().getFranco() != null && temp.getProveedor().getFranco() > temp.getImportePC()) {
//                                    temp.setLlegaAFranco(false);
//
//                                }
//                                hpedido.update(temp);
//
...
//        List<Pedido> pedidosEnCursoTienda = new ArrayList<>();
